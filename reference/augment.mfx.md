...
[`glance.betamfx()`](https://broom.tidymodels.org/reference/glance.betamfx.md),
[`glance.mfx()`](https://broom.tidymodels.org/reference/glance.mfx.md),
[`tidy.betamfx()`](https://broom.tidymodels.org/reference/tidy.betamfx.md),
[`tidy.mfx()`](https://broom.tidymodels.org/reference/tidy.mfx.md)
...
#>  1 Mazda RX4          1     6   110  2.62  2.24    0.449  0.278   0.691
#>  2 Mazda RX4 Wag      1     6   110  2.88 -0.0912  1.22   0.352   0.648
#>  3 Datsun 710         1     4    93  2.32  3.46    0.249  0.0960  0.694
#>  4 Hornet 4 Drive     0     6   110  3.22 -3.20   -0.282  0.0945  0.694
#>  5 Hornet Sporta…     0     8   175  3.44 -2.17   -0.466  0.220   0.691
#>  6 Valiant            0     6   105  3.46 -5.61   -0.0856 0.0221  0.695
#>  7 Duster 360         0     8   245  3.57 -1.07   -0.766  0.337   0.681
#>  8 Merc 240D          0     4    62  3.19 -5.51   -0.0897 0.0376  0.695
#>  9 Merc 230           0     4    95  3.15 -4.07   -0.184  0.122   0.694
#> 10 Merc 280           0     6   123  3.44 -4.84   -0.126  0.0375  0.694
#> # ℹ 22 more rows
...
#>    .rownames         am   cyl    hp    wt .fitted  .resid   .hat .sigma
#>    <chr>          <dbl> <dbl> <dbl> <dbl>   <dbl>   <dbl>  <dbl>  <dbl>
#>  1 Mazda RX4          1     6   110  2.62   1.21   0.490  0.308   0.633
#>  2 Mazda RX4 Wag      1     6   110  2.88  -0.129  1.27   0.249   0.588
#>  3 Datsun 710         1     4    93  2.32   1.85   0.256  0.134   0.637
#>  4 Hornet 4 Drive     0     6   110  3.22  -1.92  -0.237  0.116   0.637
#>  5 Hornet Sporta…     0     8   175  3.44  -1.25  -0.474  0.236   0.633
#>  6 Valiant            0     6   105  3.46  -3.30  -0.0312 0.0111  0.638
#>  7 Duster 360         0     8   245  3.57  -0.595 -0.804  0.285   0.622
#>  8 Merc 240D          0     4    62  3.19  -3.31  -0.0304 0.0179  0.638
#>  9 Merc 230           0     4    95  3.15  -2.47  -0.116  0.130   0.638
#> 10 Merc 280           0     6   123  3.44  -2.85  -0.0662 0.0315  0.638
#> # ℹ 22 more rows
#> # ℹ 2 more variables: .cooksd <dbl>, .std.resid <dbl>
glance(mod_probmfx)
#> # A tibble: 1 × 8
