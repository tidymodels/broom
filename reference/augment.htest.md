...
[`tidy.pairwise.htest()`](https://broom.tidymodels.org/reference/tidy.pairwise.htest.md),
[`tidy.power.htest()`](https://broom.tidymodels.org/reference/tidy.power.htest.md)
...
#> 1   -0.177    -0.539   0.603         9   -0.918     0.565 One Sample t…
