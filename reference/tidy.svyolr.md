...
[`tidy.polr()`](https://broom.tidymodels.org/reference/tidy.polr.md) is
both computationally intensive and specific to that model, so the
...
[`glance.clm()`](https://broom.tidymodels.org/reference/glance.clm.md),
[`glance.clmm()`](https://broom.tidymodels.org/reference/glance.clmm.md),
[`glance.polr()`](https://broom.tidymodels.org/reference/glance.polr.md),
[`glance.svyolr()`](https://broom.tidymodels.org/reference/glance.svyolr.md),
[`tidy.clm()`](https://broom.tidymodels.org/reference/tidy.clm.md),
[`tidy.clmm()`](https://broom.tidymodels.org/reference/tidy.clmm.md),
[`tidy.polr()`](https://broom.tidymodels.org/reference/tidy.polr.md)
