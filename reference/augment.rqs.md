...
[`quantreg::rq()`](https://rdrr.io/pkg/quantreg/man/rq.html),
[`quantreg::predict.rqs()`](https://rdrr.io/pkg/quantreg/man/predict.rq.html)

Other quantreg tidiers:
[`augment.nlrq()`](https://broom.tidymodels.org/reference/augment.nlrq.md),
[`augment.rq()`](https://broom.tidymodels.org/reference/augment.rq.md),
[`glance.nlrq()`](https://broom.tidymodels.org/reference/glance.nlrq.md),
[`glance.rq()`](https://broom.tidymodels.org/reference/glance.rq.md),
[`tidy.nlrq()`](https://broom.tidymodels.org/reference/tidy.nlrq.md),
[`tidy.rq()`](https://broom.tidymodels.org/reference/tidy.rq.md),
[`tidy.rqs()`](https://broom.tidymodels.org/reference/tidy.rqs.md)
