...
If the weights for any of the observations in the model are 0, then
columns ".infl" and ".hat" in the result will be 0 for those
observations.

A `.resid` column is not calculated when data is specified via the
`newdata` argument.
