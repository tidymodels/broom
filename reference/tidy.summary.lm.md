...
[`tidy.lm()`](https://broom.tidymodels.org/reference/tidy.lm.md). For
instance, if users have already converted large `lm` objects into their
leaner `summary.lm` equivalents to conserve memory.
