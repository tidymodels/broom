...
[`tidy.rlm()`](https://broom.tidymodels.org/reference/tidy.rlm.md).
...
[`augment.glmrob()`](https://broom.tidymodels.org/reference/augment.robustbase.glmrob.md),
[`augment.lmrob()`](https://broom.tidymodels.org/reference/augment.robustbase.lmrob.md),
[`glance.lmrob()`](https://broom.tidymodels.org/reference/glance.robustbase.lmrob.md),
[`tidy.glmrob()`](https://broom.tidymodels.org/reference/tidy.robustbase.glmrob.md)
