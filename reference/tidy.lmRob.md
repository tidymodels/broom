...
[`augment.lmRob()`](https://broom.tidymodels.org/reference/augment.lmRob.md),
[`glance.glmRob()`](https://broom.tidymodels.org/reference/glance.glmRob.md),
[`glance.lmRob()`](https://broom.tidymodels.org/reference/glance.lmRob.md),
[`tidy.glmRob()`](https://broom.tidymodels.org/reference/tidy.glmRob.md)
