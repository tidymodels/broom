...
[`augment.speedlm()`](https://broom.tidymodels.org/reference/augment.speedlm.md),
[`glance.speedglm()`](https://broom.tidymodels.org/reference/glance.speedglm.md),
[`glance.speedlm()`](https://broom.tidymodels.org/reference/glance.speedlm.md),
[`tidy.speedglm()`](https://broom.tidymodels.org/reference/tidy.speedglm.md)
