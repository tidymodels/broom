...
[`tidy.emmGrid()`](https://broom.tidymodels.org/reference/tidy.emmGrid.md),
[`tidy.ref.grid()`](https://broom.tidymodels.org/reference/tidy.ref.grid.md),
[`tidy.summary_emm()`](https://broom.tidymodels.org/reference/tidy.summary_emm.md)
