globalVariables(c(
  ".", "estimate", "std.error", "statistic", "term", "p.value",
  ...
  "Var2", "variable", "data", "std.dev", "percent", ".rownames",
  "ci.lower", "ci.upper", "est", "lhs", "nobs", "norig", "op",
  "pvalue", "rhs",   "rmsea.ci.upper", "rowname", "z"))
