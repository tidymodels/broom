...
#' [svd()] or [irlba::irlba()] functions into a tidy format.
#' Because `svd` and `irlba` return lists without classes, this function
#' has to be called by [tidy.list()] when it recognizes a list as an
#' SVD or `irlba` object.
#'
...
#' @name svd_tidiers
#'
#' @param x list containing d, u, v components, returned from `svd` or
#'   `irlba`
