...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      Backtrace:
        1. mice::D3(fit1, fit0)
        2. mice::pool(fit1)
        3. mice:::pool.fitlist(getfit(object), dfcom = dfcom)
        5. mice:::summary.mira(fitlist, type = "tidy", exponentiate = FALSE)
        9. base::lapply(...)
       11. broom:::tidy.default(X[[i]], ...)
      
      ══ testthat results  ═══════════════════════════════════════════════════════════
      [ OK: 286 | SKIPPED: 0 | WARNINGS: 0 | FAILED: 1 ]
