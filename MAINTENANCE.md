...
A number of methods were deprecated in the 0.7.0 release of broom—five years ago now—and need to be removed completely. Those are contained in `R/deprecated-0-7-0.R`. Removing them results in double-digit breakages of reverse dependencies, but they will need to be removed sooner than later in anticipation of changes in R itself [TODO: link issue]. Happy to help out with the revdep breakages.
