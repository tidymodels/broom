...
- Corrected confidence interval values in
  [`tidy.boot()`](https://broom.tidymodels.org/dev/reference/tidy.boot.md)
...
- Corrected coefficient values in
  [`tidy.varest()`](https://broom.tidymodels.org/dev/reference/tidy.varest.md)
...
- Added an `intercept` argument to
  ...
  a logical indicating whether to include information on the intercept
  as the first row of results
...
- Moves forward with deprecation of tidiers for sparse matrices
  ...
  [`tidy.confusionMatrix()`](https://broom.tidymodels.org/dev/reference/tidy.confusionMatrix.md),
...
- Adds a dedicated `glance.anova` method (which previously dispatched to
  the  
  deprecated
  [`glance.data.frame()`](https://broom.tidymodels.org/dev/reference/data.frame_tidiers.md)
...
- Clarifies documentation related to usage of
  [`augment_columns()`](https://broom.tidymodels.org/dev/reference/augment_columns.md);
...
[`tidy.lm()`](https://broom.tidymodels.org/dev/reference/tidy.lm.md), or
similarly for
[`tidy.glm()`](https://broom.tidymodels.org/dev/reference/tidy.glm.md).
...
- Added tidier methods for `mlogit` objects (`#887` by
  `@gregmacfarlane`)
- Add
  [`glance.coeftest()`](https://broom.tidymodels.org/dev/reference/glance.coeftest.md)
...
- Fixed a bug related to
  [`tidy.geeglm()`](https://broom.tidymodels.org/dev/reference/tidy.geeglm.md)
...
- [`augment.glmRob()`](https://broom.tidymodels.org/dev/reference/augment.glmRob.md)
- [`tidy.table()`](https://broom.tidymodels.org/dev/reference/tidy.table.md)
  and
  [`tidy.ftable()`](https://broom.tidymodels.org/dev/reference/tidy.ftable.md)
  have been deprecated in favor of
  [`tibble::as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.html)
- [`tidy.summaryDefault()`](https://broom.tidymodels.org/dev/reference/summary_tidiers.md)
  and
  [`glance.summaryDefault()`](https://broom.tidymodels.org/dev/reference/summary_tidiers.md)
...
- [`tidy.zoo()`](https://broom.tidymodels.org/dev/reference/tidy.zoo.md)
  now doesn’t change column names that have spaces or other special
...
- [`vignette("available-methods", package = "broom")`](https://broom.tidymodels.org/dev/articles/available-methods.md)
  contains a table detailing which tidying methods are available

- [`vignette("adding-tidiers", package = "broom")`](https://broom.tidymodels.org/dev/articles/adding-tidiers.md)
...
- [`vignette("bootstrapping", package = "broom")`](https://broom.tidymodels.org/dev/articles/bootstrapping.md)
...
- Added tidiers for `rlm` (robust linear model) and `gam` (generalized
  ...
  [`?rlm_tidiers`](https://broom.tidymodels.org/dev/reference/glance.rlm.md)
  and
  [`?gam_tidiers`](https://broom.tidymodels.org/dev/reference/tidy.gam.md)
  for more.
