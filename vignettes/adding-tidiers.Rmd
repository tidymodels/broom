...
`glance` should not return convergence information about a model. The goal of `glance` is to helper users assess how well their model fits the data they have, not to help them determine if their model estimation procedure was successful.
