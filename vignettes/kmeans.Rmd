...
This is an ideal case for k-means clustering. We'll use the built-in `kmeans` function, which accepts a matrix of a dataframe with all numeric columns as it's primary argument.
